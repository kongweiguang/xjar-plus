...
public class MyTest {
    ...
    public void test1() throws Exception {
        XCryptos.encryption()
                //原始jar
                .from("C:\\dev\\java\\xm\\my\\boot3-demo1\\target\\boot3-demo1-0.0.1-SNAPSHOT.jar")
                //密码
                .password("woshimimao")
                ...
                //jdk的zip包地址（需要放到目标机器执行的jdk版本，一般是linux下的jdk）
                ...
                //打包到boboji目标路径
                .to("C:\\dev\\java\\xm\\my\\boot3-demo1\\target\\boboji", "bala.jar");
    }
}
